        ...
        >
          <Box>
            ...
            <Typography variant="h3" sx={{ fontWeight: 800, color: "#172033" }}>
              Bacart round history
            </Typography>
            <Typography color="text.secondary">
            Live Bacart game results.
            </Typography>
          </Box>
        ...
        >
          <CardContent sx={{ p: { xs: 2, md: 3 } }}>
            ...
            {loading ? (
              ...
              <TableContainer sx={{ border: "1px solid #e3e9f2", borderRadius: 3 }}>
                  <Table size="small" aria-label="Bacart round history table">
                    <TableHead>
                      <TableRow>
                        <TableCell>Time</TableCell>
                        <TableCell>Round values</TableCell>
                        <TableCell align="right">Last value</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {tableRows.map(({ time, values, lastValue }) => (
                        <TableRow key={time}>
                          <TableCell>{time}</TableCell>
                          <TableCell>
                          ...
                          <TableCell align="right">{formatValue(lastValue)}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
